...
for i in range(1, 10):
    txt1 = Entry(F2, width=30, font='arial 15', bd=1, justify=CENTER, highlightthickness=u.border_size,
                 highlightcolor=u.entry_correct_color)
    txt1.grid(row=i, column=1, padx=4, pady=3)
    u.entry_list.append(txt1)
    u.des_txt.append(txt1)

    txt2 = Entry(F2, width=9, font='arial 15', bd=1, justify=CENTER, highlightthickness=u.border_size,
                 highlightcolor=u.entry_correct_color)
    txt2.grid(row=i, column=3, padx=4, pady=3)
    u.entry_list.append(txt2)
    u.wt_txt.append(txt2)

    txt3 = Entry(F2, width=16, font='arial 15', bd=1, justify=CENTER, highlightthickness=u.border_size,
                 highlightcolor=u.entry_correct_color)
    txt3.grid(row=i, column=4, padx=4, pady=3)
    u.entry_list.append(txt3)
    u.net_txt.append(txt3)

    txt4 = Entry(F2, width=9, font='arial 15', bd=1, justify=CENTER, highlightthickness=u.border_size,
                 highlightcolor=u.entry_correct_color)
    ...
    txt7 = Entry(F2, width=10, font='arial 15', bd=1, justify=CENTER, highlightthickness=u.border_size,
                 highlightcolor=u.entry_correct_color)
    txt7.grid(row=i, column=8, padx=4, pady=3)
    txt7.config(state=DISABLED)
    u.sgst_txt.append(txt7)

    txt8 = Entry(F2, width=10, font='arial 15', bd=1, justify=CENTER, highlightthickness=u.border_size,
                 highlightcolor=u.entry_correct_color)
...
u.charge = Entry(F5, width=15, font='arial 14', bd=1, justify=CENTER, highlightthickness=u.border_size,
                 highlightcolor=u.entry_correct_color)
...
u.total = Entry(F5, width=15, font='arial 14', bd=1, justify=CENTER, highlightthickness=u.border_size,
                highlightcolor=u.entry_correct_color)
...
u.generateBtn = Button(F6, text="Generate Bill", font=('times new rommon', 13), command=lambda: generateBill(u),
                       bg=u.bg_color, bd=2)
...
u.findgoldBtn = Button(F6, text="Find GR", font=('times new rommon', 13), command=lambda: findGoldRateOnDate(u),
                       bg=u.bg_color, bd=2)
