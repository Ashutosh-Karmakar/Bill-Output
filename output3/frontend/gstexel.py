...
def create(data, u: UiFields):
    ...
    sh1['C1'].font = Font(name='times new rommon', size=18, bold=True, italic=False, vertAlign=None, underline='none',
                          strike=False, color=u.red)
    sh1['E1'] = "TO"
    sh1['E1'].font = Font(name='times new rommon', size=18, bold=True, italic=False, vertAlign=None, underline='none',
                          strike=False, color=u.red)
    sh1['G1'] = '{:%b %d, %Y}'.format(u.cal2)
    sh1['G1'].font = Font(name='times new rommon', size=18, bold=True, italic=False, vertAlign=None, underline='none',
                          strike=False, color=u.red)
    ...
    if not os.path.exists(u.BASEDIR_GST):
