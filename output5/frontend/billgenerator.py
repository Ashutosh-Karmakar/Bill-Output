...
def generateBill(u: UiFields):
    ...
    sh1['D1'].font = Font(name='Copperplate Gothic Bold', size=35, bold=False, italic=False, vertAlign=None,
                          underline='none', strike=False, color='c24949')

    sh1['D2'] = "    Badheibanka Chawk, Old Town, Bhubaneswar, Mob.: 9090280083,9861230757"
    sh1['D2'].font = Font(name='times new rommon', size=16, bold=False, italic=False, vertAlign=None, underline='none',
                          strike=False, color='009966')  # '064635')

    sh1['E3'] = "            916 GOLD AND SILVER ORNAMENT"
    sh1['E3'].font = Font(name='times new rommon', size=16, bold=False, italic=False, vertAlign=None, underline='none',
                          strike=False, color='c85c5c')

    sh1['F4'] = "                 Tax Invoice"
    sh1['F4'].font = Font(name='times new rommon', size=16, bold=True, italic=False, vertAlign=None, underline='none',
                          strike=False, color='c85c5c')
    ...
    sh1['A5'].font = Font(name='times new rommon', size=13, bold=False, italic=False, vertAlign=None, underline='none',
                          strike=False, color=u.red)

    sh1['F5'] = "Bill. No.: "
    sh1['F5'].font = Font(name='times new rommon', size=16, bold=False, italic=False, vertAlign=None, underline='none',
                          strike=False, color=u.green)
    sh1['G5'] = u.bill_txt
    sh1['G5'].font = Font(name='times new rommon', size=15, bold=False, italic=False, vertAlign=None, underline='none',
                          strike=False, color=u.red)

    sh1['I5'] = 'Date: ' + daten.strftime("%d-%b-%y - (%A)")
    sh1['I5'].font = Font(name='times new rommon', size=15, bold=False, italic=False, vertAlign=None, underline='none',
                          strike=False, color=u.green)

    sh1['A6'] = "Name: "
    sh1['A6'].font = Font(name='times new rommon', size=16, bold=False, italic=False, vertAlign=None, underline='none',
                          strike=False, color=u.green)
    sh1['B6'] = u.name_txt.get()
    sh1['B6'].font = Font(name='arial', size=15, bold=False, italic=False, vertAlign=None, underline='none',
                          strike=False, color=u.red)

    sh1['E6'] = 'Mobile No.'
    sh1['E6'].font = Font(name='times new rommon', size=16, bold=False, italic=False, vertAlign=None, underline='none',
                          strike=False, color=u.green)
    sh1['F6'] = '  ' + u.mobile_txt.get()
    sh1['F6'].font = Font(name='arial', size=15, bold=False, italic=False, vertAlign=None, underline='none',
                          strike=False, color=u.red)

    sh1['H6'] = 'Addhar No.'
    sh1['H6'].font = Font(name='times new rommon', size=16, bold=False, italic=False, vertAlign=None, underline='none',
                          strike=False, color=u.green)
    sh1['I6'] = u.addhar_txt.get()
    sh1['I6'].font = Font(name='arial', size=15, bold=False, italic=False, vertAlign=None, underline='none',
                          strike=False, color=u.red)

    sh1['F7'] = "Gold Rate: "
    sh1['F7'].font = Font(name='times new rommon', size=16, bold=False, italic=False, vertAlign=None, underline='none',
                          strike=False, color=u.green)
    sh1['G7'] = u.gold_rate * 10
    sh1['G7'].font = Font(name='arial', size=15, bold=False, italic=False, vertAlign=None, underline='none',
                          strike=False, color=u.red)

    # ===========================================product details======================================================================

    sh1['A8'] = 'Si.'
    sh1['A8'].font = Font(name='times new romman', size=13, bold=False, italic=False, vertAlign=None, underline='none',
                          strike=False, color=u.green)
    sh1['B8'] = 'Description Of Goods'
    sh1['B8'].font = Font(name='times new romman', size=16, bold=False, italic=False, vertAlign=None, underline='none',
                          strike=False, color=u.green)
    sh1['E8'] = 'HSN'
    sh1['E8'].font = Font(name='times new romman', size=16, bold=False, italic=False, vertAlign=None, underline='none',
                          strike=False, color=u.green)
    sh1['E9'] = 'SAC'
    sh1['E9'].font = Font(name='times new romman', size=16, bold=False, italic=False, vertAlign=None, underline='none',
                          strike=False, color=u.green)

    sh1['F8'] = 'Weight'
    sh1['F8'].font = Font(name='times new romman', size=16, bold=False, italic=False, vertAlign=None, underline='none',
                          strike=False, color=u.green)

    sh1['G8'] = 'MC'
    sh1['G8'].font = Font(name='times new romman', size=16, bold=False, italic=False, vertAlign=None, underline='none',
                          strike=False, color=u.green)

    sh1['H8'] = 'Unit'
    sh1['H8'].font = Font(name='times new romman', size=16, bold=False, italic=False, vertAlign=None, underline='none',
                          strike=False, color=u.green)
    sh1['H9'] = 'Price'
    sh1['H9'].font = Font(name='times new romman', size=16, bold=False, italic=False, vertAlign=None, underline='none',
                          strike=False, color=u.green)

    sh1['I8'] = 'CGST'
    sh1['I8'].font = Font(name='times new romman', size=16, bold=False, italic=False, vertAlign=None, underline='none',
                          strike=False, color=u.green)
    sh1['I9'] = '1.5%'
    sh1['I9'].font = Font(name='times new romman', size=16, bold=False, italic=False, vertAlign=None, underline='none',
                          strike=False, color=u.green)

    sh1['J8'] = 'SGST'
    sh1['J8'].font = Font(name='times new romman', size=16, bold=False, italic=False, vertAlign=None, underline='none',
                          strike=False, color=u.green)
    sh1['J9'] = '1.5%'
    sh1['J9'].font = Font(name='times new romman', size=16, bold=False, italic=False, vertAlign=None, underline='none',
                          strike=False, color=u.green)

    sh1['K8'] = 'Net'
    sh1['K8'].font = Font(name='times new romman', size=16, bold=False, italic=False, vertAlign=None, underline='none',
                          strike=False, color=u.green)
    sh1['K9'] = 'Total'
    sh1['K9'].font = Font(name='times new romman', size=16, bold=False, italic=False, vertAlign=None, underline='none',
                          strike=False, color=u.green)

    sh1['E10'] = '7113'
    sh1['E10'].font = Font(name='arial', size=12, bold=False, italic=False, vertAlign=None, underline='none',
                           strike=False, color=u.blue)

    for i in range(1, 10):
        if (u.des_txt[i - 1].get() != ""):
            sh1['A' + str(i + 9)] = i
            sh1['A' + str(i + 9)].font = Font(name='arial', size=15, bold=False, italic=False, vertAlign=None,
                                              underline='none', strike=False, color=u.blue)

            sh1['B' + str(i + 9)] = u.des_txt[i - 1].get()
            sh1['B' + str(i + 9)].font = Font(name='arial', size=15, bold=False, italic=False, vertAlign=None,
                                              underline='none', strike=False, color=u.blue)

            sh1['F' + str(i + 9)] = u.wt_txt[i - 1].get() + 'gm'
            sh1['F' + str(i + 9)].font = Font(name='arial', size=15, bold=False, italic=False, vertAlign=None,
                                              underline='none', strike=False, color=u.blue)

            sh1['G' + str(i + 9)] = u.mc_txt[i - 1].get()
            sh1['G' + str(i + 9)].font = Font(name='arial', size=15, bold=False, italic=False, vertAlign=None,
                                              underline='none', strike=False, color=u.blue)

            sh1['H' + str(i + 9)] = u.unit_txt[i - 1].get()
            sh1['H' + str(i + 9)].font = Font(name='arial', size=15, bold=False, italic=False, vertAlign=None,
                                              underline='none', strike=False, color=u.blue)

            sh1['I' + str(i + 9)] = u.cgst_txt[i - 1].get()
            sh1['I' + str(i + 9)].font = Font(name='arial', size=15, bold=False, italic=False, vertAlign=None,
                                              underline='none', strike=False, color=u.blue)

            sh1['J' + str(i + 9)] = u.sgst_txt[i - 1].get()
            sh1['J' + str(i + 9)].font = Font(name='arial', size=15, bold=False, italic=False, vertAlign=None,
                                              underline='none', strike=False, color=u.blue)

            sh1['K' + str(i + 9)] = u.net_txt[i - 1].get()
            sh1['K' + str(i + 9)].font = Font(name='arial', size=15, bold=False, italic=False, vertAlign=None,
                                              underline='none', strike=False, color=u.blue)
        ...
        # ===========================================================old gold============================================================
        sh1['A19'] = 'Si.'
        sh1['A19'].font = Font(name='Times new romman', size=13, bold=False, italic=False, vertAlign=None,
                               underline='none', strike=False, color=u.blue)

        sh1['D19'] = "Old Jewellery"
        sh1['D19'].font = Font(name='Times new romman', size=16, bold=False, italic=False, vertAlign=None,
                               underline='none', strike=False, color=u.green)

        sh1['I19'] = "Weight"
        sh1['I19'].font = Font(name='Times new romman', size=16, bold=False, italic=False, vertAlign=None,
                               underline='none', strike=False, color=u.green)

        sh1['J19'] = "Unit Price"
        sh1['J19'].font = Font(name='Times new romman', size=16, bold=False, italic=False, vertAlign=None,
                               underline='none', strike=False, color=u.green)

        sh1['K19'] = "Total"
        sh1['K19'].font = Font(name='Times new romman', size=16, bold=False, italic=False, vertAlign=None,
                               underline='none', strike=False, color=u.green)
        for i in range(1, 4):
            if u.oldtotal_txt[i - 1].get() != "":
                sh1['A2' + str(i - 1)] = i
                sh1['A2' + str(i - 1)].font = Font(name='arial', size=15, bold=False, italic=False, vertAlign=None,
                                                   underline='none', strike=False, color=u.blue)

                sh1['B2' + str(i - 1)] = u.oldDesc_txt[i - 1].get()
                sh1['B2' + str(i - 1)].font = Font(name='arial', size=15, bold=False, italic=False, vertAlign=None,
                                                   underline='none', strike=False, color=u.blue)

                sh1['I2' + str(i - 1)] = u.oldwe_txt[i - 1].get()
                sh1['I2' + str(i - 1)].font = Font(name='arial', size=15, bold=False, italic=False, vertAlign=None,
                                                   underline='none', strike=False, color=u.blue)

                sh1['J2' + str(i - 1)] = u.oldunit_txt[i - 1].get()
                sh1['J2' + str(i - 1)].font = Font(name='arial', size=15, bold=False, italic=False, vertAlign=None,
                                                   underline='none', strike=False, color=u.blue)

                sh1['K2' + str(i - 1)] = u.oldtotal_txt[i - 1].get()
                sh1['K2' + str(i - 1)].font = Font(name='arial', size=15, bold=False, italic=False, vertAlign=None,
                                                   underline='none', strike=False, color=u.blue)

        # ====================================================ADDITION OR DEDUCTION================================================================================================================
        sh1['A24'] = 'Si.'
        sh1['A24'].font = Font(name='Times new romman', size=13, bold=False, italic=False, vertAlign=None,
                               underline='none', strike=False, color=u.green)

        sh1['C24'] = "Other Addition Or Deduction"
        sh1['C24'].font = Font(name='Times new romman', size=16, bold=False, italic=False, vertAlign=None,
                               underline='none', strike=False, color=u.green)

        sh1['K24'] = "Amount"
        sh1['K24'].font = Font(name='Times new romman', size=16, bold=False, italic=False, vertAlign=None,
                               underline='none', strike=False, color=u.green)

        for i in range(1, 4):
            if u.addtotal_txt[i - 1].get() != "":
                sh1['A2' + str(i + 4)] = i
                sh1['A2' + str(i + 4)].font = Font(name='arial', size=15, bold=False, italic=False, vertAlign=None,
                                                   underline='none', strike=False, color=u.blue)

                sh1['B2' + str(i + 4)] = u.addDesc_txt[i - 1].get()
                sh1['B2' + str(i + 4)].font = Font(name='arial', size=15, bold=False, italic=False, vertAlign=None,
                                                   underline='none', strike=False, color=u.blue)

                sh1['K2' + str(i + 4)] = u.addtotal_txt[i - 1].get()
                sh1['K2' + str(i + 4)].font = Font(name='arial', size=15, bold=False, italic=False, vertAlign=None,
                                                   underline='none', strike=False, color=u.blue)

        # ===================================================mode of payment============================================

        sh1['E28'] = "Mode Of Payment"
        sh1['E28'].font = Font(name='Times new romman', size=16, bold=False, italic=False, vertAlign=None,
                               underline='none', strike=False, color=u.red)
        mode = u.mode
        if (u.charge.get() != ''):
            mode = mode + ':    ' + u.charge.get()
        sh1['I28'] = mode
        sh1['I28'].font = Font(name='arial', size=15, bold=False, italic=False, vertAlign=None, underline='none',
                               strike=False, color=u.blue)

        # =====================================================Total paid=======================================================

        sh1['A29'] = "Total in Words"
        sh1['A29'].font = Font(name='Times new romman', size=16, bold=False, italic=False, vertAlign=None,
                               underline='none', strike=False, color=u.red)
        try:
            tot = int(float(u.total.get()))
            sh1['C29'] = convert(tot)
            sh1['C29'].font = Font(name='arial', size=15, bold=False, italic=False, vertAlign=None, underline='none',
                                   strike=False, color=u.blue)
        except Exception as e:
            print("There is a error in convert : {0}".format(e))

        sh1['J29'] = "Total Paid : "
        sh1['J29'].font = Font(name='Times new romman', size=16, bold=False, italic=False, vertAlign=None,
                               underline='none', strike=False, color=u.red)
        sh1['K29'] = u.total.get()
        sh1['K29'].font = Font(name='arial', size=15, bold=False, italic=False, vertAlign=None, underline='none',
                               strike=False, color=u.blue)
